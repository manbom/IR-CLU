...
const t = dictionaries.en.automationCheck;

export const metadata: Metadata = {
  title: `${t.title} | IR-CLU`,
  description: t.description,
  alternates: { canonical: "/en/automation-check/" },
  openGraph: {
    title: t.title,
    description: t.description,
    type: "website",
    url: "/en/automation-check/",
  },
};

export default function EnglishAutomationCheckPage() {
  return (
