...
export function Hero() {
  ...
  // "Forward" affordance — points into reading direction (left in RTL, right in LTR).
  // lucide icons don't auto-flip with `dir`, so this is picked explicitly per locale.
      ...
      <Container className="relative z-10 py-32">
        ...
        >
          ...
          >
            {t.titleLine1}
            <br />
            <span className="text-gradient-signal">{t.titleGradient}</span>
          </motion.h1>
